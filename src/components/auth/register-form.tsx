  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-stone-100">Buat Akun Baru</h1>
        <p className="text-gray-500 mt-1 dark:text-stone-400">Daftar dan mulai berbelanja produk UMKM</p>
      </div>

      <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 p-6 md:p-8 border border-gray-100 dark:bg-stone-900 dark:border-stone-800">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 dark:text-stone-300">Nama Lengkap</label>
            <div className="relative">
              <User size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 dark:text-stone-500" />
              <Input
          ...
          <div>
            ...
            <div className="relative">
              <Mail size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 dark:text-stone-500" />
              <Input
                type="email"
          ...
          <div>
            ...
            <div className="relative">
              <Phone size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 dark:text-stone-500" />
              <Input
                type="tel"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 dark:text-stone-300">Password</label>
            <div className="relative">
              <Lock size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 dark:text-stone-500" />
              <Input
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:text-stone-500"
              >
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-white px-4 text-gray-500 dark:bg-stone-900 dark:text-stone-400">atau daftar dengan</span>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6 dark:text-stone-400">
          Sudah punya akun?{" "}
