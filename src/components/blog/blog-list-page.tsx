      ...
      <section className="bg-gradient-to-br from-gray-50 via-white to-blue-50 py-16">
        <div className="container mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold text-gray-900 mt-2">Artikel & Inspirasi UMKM</h1>
            <p className="text-gray-500 mt-3 max-w-lg mx-auto">Tips, cerita sukses, dan berita terkini seputar UMKM Indonesia</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          {posts.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="text-gray-500 text-sm">Artikel akan segera hadir, nantikan ya!</p>
            </div>
          ) : (
            <>
              {featured && (
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
                  <Link href={`/blog/${featured.slug}`} className="grid md:grid-cols-2 gap-6 group items-center bg-gray-50 rounded-3xl overflow-hidden">
                    ...
                    <div className="p-6 md:p-8">
                      ...
                      <p className="text-gray-500 mb-4 line-clamp-2">{featured.excerpt}</p>
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <Link href={`/blog/${post.slug}`}>
                        <h3 className="font-semibold text-gray-900 line-clamp-2 mb-2 group-hover:text-blue-600 transition-colors">{post.title}</h3>
                      </Link>
