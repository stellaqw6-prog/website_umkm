...
const fallbackStyle = { icon: Package, color: "from-gray-500 to-gray-600", bg: "bg-gray-50 dark:bg-stone-800" };
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="flex flex-col items-center gap-3 p-5 rounded-2xl hover:bg-gray-50 transition-all group dark:hover:bg-stone-900"
                >
                  <div
                  ...
                  <div className="text-center">
                    <p className="font-semibold text-gray-900 text-sm dark:text-stone-200">{cat.name}</p>
                  </div>
                </Link>
              </motion.div>
            );
