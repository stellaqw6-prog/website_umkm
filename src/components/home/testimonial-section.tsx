        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="bg-gray-50 rounded-2xl p-6 relative group hover:shadow-lg transition-all"
            >
              <Quote className="absolute top-4 right-4 text-gray-200 w-10 h-10 group-hover:text-blue-100 transition-colors" />
