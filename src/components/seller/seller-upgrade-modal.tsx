              ...
              {sessionLoading || loading ? (
                ...
                <>
                  ...
                  {existingRequest?.status === "rejected" && (
                    <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-4 flex gap-3 dark:bg-red-950/20 dark:border-red-900/40">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4 mb-5 text-center dark:bg-blue-950/20">
