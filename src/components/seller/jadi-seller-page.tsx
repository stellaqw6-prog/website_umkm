    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center text-center px-4">
        <div>
          ...
          <p className="text-gray-500 mb-6">Silakan login untuk mengajukan jadi seller.</p>
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center text-center px-4">
        <div>
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Kamu Sudah Punya Akses Toko</h2>
          <p className="text-gray-500 mb-6">Akun kamu sudah berstatus {user.role === "seller" ? "seller" : "staf"}.</p>
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center text-center px-4">
        <div className="max-w-md">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Menunggu Verifikasi</h2>
    ...
    <section className="py-12 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 max-w-lg">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Buka Toko Sendiri</h1>
          <p className="text-gray-500 mt-2">Punya UMKM sendiri? Daftar jadi seller dan mulai jualan di platform ini.</p>
        </motion.div>
