      ...
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        {orders.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-2xl border border-gray-100">
            ...
            <h3 className="font-semibold text-gray-900 mb-1">Belum ada pesanan</h3>
            <p className="text-gray-500 text-sm mb-6">Yuk mulai belanja produk UMKM favoritmu!</p>
            ...
            {orders.map((order, i) => (
              <motion.div key={order.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}>
                <Link
                  ...
                  className="flex items-center gap-4 bg-white rounded-2xl border border-gray-100 p-4 hover:shadow-md transition-all"
                >
                  ...
                  <div className="text-right flex-shrink-0">
                    <p className="font-semibold text-gray-900 text-sm">{formatCurrency(Number(order.grandTotal))}</p>
