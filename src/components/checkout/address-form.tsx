  ...
  return (
    <div className="space-y-4">
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          <label className="text-sm font-medium text-gray-700 mb-1.5 flex items-center gap-1 dark:text-stone-300"><User size={14} /> Nama Penerima</label>
          <Input required placeholder="Nama lengkap penerima" value={recipientName} onChange={(e) => setRecipientName(e.target.value)} />
        </div>
        <div>
          <label className="text-sm font-medium text-gray-700 mb-1.5 flex items-center gap-1 dark:text-stone-300"><Phone size={14} /> Nomor HP</label>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          <label className="text-sm font-medium text-gray-700 mb-1.5 block dark:text-stone-300">Provinsi</label>
        ...
        <div>
          <label className="text-sm font-medium text-gray-700 mb-1.5 block dark:text-stone-300">Kabupaten/Kota</label>
          <div className="relative">
            <select
              required
              className={selectClass}
        ...
        <div>
          <label className="text-sm font-medium text-gray-700 mb-1.5 block dark:text-stone-300">Kecamatan</label>
          <div className="relative">
            <select
              required
              className={selectClass}
        ...
        <div>
          <label className="text-sm font-medium text-gray-700 mb-1.5 block dark:text-stone-300">Kelurahan/Desa</label>
          <div className="relative">
            <select
              required
              className={selectClass}
      ...
      <div>
        <label className="text-sm font-medium text-gray-700 mb-1.5 block dark:text-stone-300">Kode Pos</label>
      ...
      <div>
        <label className="text-sm font-medium text-gray-700 mb-1.5 block dark:text-stone-300">Alamat Lengkap (Jalan, RT/RW, Nomor Rumah, Patokan)</label>
        <Textarea
          required
          rows={3}
