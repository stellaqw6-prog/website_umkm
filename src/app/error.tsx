  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-blue-50 px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-xl font-bold text-gray-900 mb-3 dark:text-gray-100">Terjadi Kesalahan</h1>
        <p className="text-gray-500 mb-8 dark:text-gray-400">Maaf, ada masalah teknis di halaman ini. Coba muat ulang, atau kembali ke beranda.</p>
