  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-blue-50 px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-6xl font-extrabold text-gray-900 mb-2 dark:text-gray-100">404</h1>
        <h2 className="text-xl font-bold text-gray-900 mb-3 dark:text-gray-100">Halaman Tidak Ditemukan</h2>
